/* taken and modified from leven by sindresorhus | https://github.com/sindresorhus/leven | MIT License : https://github.com/sindresorhus/leven/blob/main/license */

import { arr } from "../array";

const array = arr<number>();
const characterCodeCache = arr<number>();
